  ...
  return (
    <div className="relative">
      ...
      <div className="absolute top-24 left-12 w-[300px] grid gap-4 italic">
        ...
        <button className="bg-color-primary px-3 py-2 text-xl text-white mt-4 transition duration-500 hover:opacity-70" onClick={handleClick}>Browse collections</button>
      </div>
    </div>
  )
}